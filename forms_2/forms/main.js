...
function writeTimer(hours, mins, secs, ms) {
    let hlpstr = '';
    hlpstr = addChar(hours, 2) + ":" + addChar(mins, 2) + ":" + addChar(secs, 2) + ".<span>" + addChar(ms, 3) + "</span>";
...
function checkForm() {
    let formdata = {
        date: $('#date')[0].value, // input id="date" value
        time: $('.timer_field')[0].innerText, // div class="timer_field" !!!без тегов!!!
        city: $('.selector').data('value'), // div class="selector" data-value
    };
